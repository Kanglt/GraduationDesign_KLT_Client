...
//                 	 .show(); 
	...
	/**
	 * 
	* @Title: updateDynamicImage 
	* @author 康良涛 
	* @Description: TODO(上传用户动态图片) 
	* @param @param cont
	* @param @param photodata
	...
	* @throws
	 */
	public static boolean addDynamicImage(final Context cont, Bitmap photodata,String photoName) {
		try {

			
			System.out.println("photodata的大小：" + photodata.getByteCount());
			String url = UrlConstant.ADDUSERDYNAMICIMAGE_URL;
			ByteArrayOutputStream baos = new ByteArrayOutputStream();
