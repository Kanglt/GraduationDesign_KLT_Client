 ...
 */
package lyu.klt.frame.ab.view.slidingmenu;
...
import lyu.klt.frame.ab.view.slidingmenu.SlidingMenu.OnClosedListener;
import lyu.klt.frame.ab.view.slidingmenu.SlidingMenu.OnOpenedListener;
...
public class CustomViewAbove extends ViewGroup {
	...
	public static class SimpleOnPageChangeListener implements OnPageChangeListener {
		...
		/* (non-Javadoc)
		 * @see com.fjzx.frame.ab.view.slidingmenu.CustomViewAbove.OnPageChangeListener#onPageScrolled(int, float, int)
		 */
		public void onPageScrolled(int position, float positionOffset, int positionOffsetPixels) {
			// This space for rent
		}
		...
		/* (non-Javadoc)
		 * @see com.fjzx.frame.ab.view.slidingmenu.CustomViewAbove.OnPageChangeListener#onPageSelected(int)
		 */
		public void onPageSelected(int position) {
			// This space for rent
		}
