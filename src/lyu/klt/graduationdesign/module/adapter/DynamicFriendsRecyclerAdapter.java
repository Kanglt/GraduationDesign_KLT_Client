...
import lyu.klt.graduationdesign.module.adapter.DynamicPersonalRecyclerAdapter.TitleHolder;
 ...
 * @Description: TODO(关注动态的RecyclerView的Adapter)
 * @author 康良涛
...
public class DynamicFriendsRecyclerAdapter extends RecyclerView.Adapter<ViewHolder>
	...
	public DynamicFriendsRecyclerAdapter(Context context, int type, List<DynamicPPo> dynamicPPoList) {
		mContext = context;
