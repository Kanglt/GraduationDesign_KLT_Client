...
package lyu.klt.frame.ab.view.wheel;
...
public class AbStringWheelAdapter implements AbWheelAdapter {
	 ...
	 * @return the item
	 * @see lyu.klt.frame.ab.view.wheel.AbWheelAdapter#getItem(int)
	 * @author: amsoft.cn
	 ...
	 * @see lyu.klt.frame.ab.view.wheel.AbWheelAdapter#getItemsCount()
	 * @author: amsoft.cn
	 * @date：2013-6-17 上午9:04:49
	 */
	@Override
	 ...
	 * @see lyu.klt.frame.ab.view.wheel.AbWheelAdapter#getMaximumLength()
	 * @author: amsoft.cn
	 * @date：2013-6-17 上午9:04:49
	 */
	@Override
