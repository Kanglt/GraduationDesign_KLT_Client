...
*
 */
public class DietReducedFatRecyclerAdapter extends RecyclerView.Adapter<ViewHolder>  {
		private final static String TAG = "DietReducedFatRecyclerAdapter";
		private Context mContext;
		private LayoutInflater mInflater;
		private int mType;
		private List<DietDataPo> dietDataList;

		public DietReducedFatRecyclerAdapter(Context context, int type, List<DietDataPo> dietDataList) {
			mContext = context;
