...
*
 */
public class UserDietRecyclerAdapter extends RecyclerView.Adapter<ViewHolder>  {
		private final static String TAG = "UserDietRecyclerAdapter";
		private Context mContext;
		private LayoutInflater mInflater;
		private int mType;
		private List<DietDataPo> dietDataList;

		public UserDietRecyclerAdapter(Context context, int type, List<DietDataPo> dietDataList) {
			mContext = context;
		...
		public ViewHolder onCreateViewHolder(ViewGroup vg, int viewType) {
			...
			v = mInflater.inflate(R.layout.recyclerview_list_item_deit_reduced_fat, vg, false);
		...
		public void onBindViewHolder(ViewHolder vh, final int position) {
			...
			holder.tv_caloriesAndProductionTime.setText(dietDataList.get(position).getCalories()+" Kcal • "+dietDataList.get(position).getProductionTime()+"min");
		...
		public class TitleHolder extends RecyclerView.ViewHolder {
			...
			public TextView tv_caloriesAndProductionTime;
			...
			public TitleHolder(View v) {
				...
				tv_caloriesAndProductionTime=(TextView) v.findViewById(R.id.tv_caloriesAndProductionTime);
		...
		ImageLoadingListener imageLoadingListener = new ImageLoadingListener() {
			...
			public void onLoadingStarted(String arg0, View arg1) {
				...
				Log.e("UserDietRecyclerAdapter", "onLoadingStarted");
			}

			@Override
			public void onLoadingFailed(String arg0, View arg1, FailReason arg2) {
				// TODO Auto-generated method stub
				Log.e("UserDietRecyclerAdapter", "onLoadingFailed");
			...
			public void onLoadingComplete(String arg0, View arg1, Bitmap arg2) {
				// TODO Auto-generated method stub
				Log.e("UserDietRecyclerAdapter", "onLoadingComplete");
			}

			@Override
			public void onLoadingCancelled(String arg0, View arg1) {
				// TODO Auto-generated method stub
				Log.e("UserDietRecyclerAdapter", "onLoadingCancelled");
			}
		};
