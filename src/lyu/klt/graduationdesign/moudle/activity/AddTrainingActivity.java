...
public class AddTrainingActivity extends BaseActivity {
	...
	private static final String TAG = AddTrainingActivity.class.getSimpleName();
	...
	private AddTrainingRecyclerAdapter mAdapter;
		...
		public void onSuccess(int statusCode, String content) {
			...
			if (!StringUtil.isEmpty(content)) {
				try {
					...
					mAdapter = new AddTrainingRecyclerAdapter(context, 1, trainingDataList);
