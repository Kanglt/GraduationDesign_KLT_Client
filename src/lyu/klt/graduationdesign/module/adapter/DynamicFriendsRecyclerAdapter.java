...
* @Description: TODO(动态模块下的子模块（好友）模块下的RecyclerView的Adapter) 
* @author 康良涛 
* @date 2016年12月16日 下午10:01:10 
*
 */
public class DynamicFriendsRecyclerAdapter extends RecyclerView.Adapter<ViewHolder> 
	...
	public DynamicFriendsRecyclerAdapter(Context context, int type, String[] titleArray) {
		mContext = context;
	...
	public void onBindViewHolder(ViewHolder vh, final int position) {
		...
		holder.tv_dynamic_user_name.setText(mTitleArray[position]);
		if (mType == 1) {  //表示是线性布局
			//params.height = 50;
	...
	public class TitleHolder extends RecyclerView.ViewHolder {
		...
		public TextView iv_dynamic_picture;
