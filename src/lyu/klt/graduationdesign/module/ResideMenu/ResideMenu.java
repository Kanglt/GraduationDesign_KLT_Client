package lyu.klt.graduationdesign.module.ResideMenu;
...
public class ResideMenu extends FrameLayout {
	...
	private void initViews(Context context, int customLeftMenuId, int customRightMenuId) {
		...
		// scrollViewRightMenu = inflater.inflate(customRightMenuId, this,
		// false);
		// } else {
		// scrollViewRightMenu = inflater.inflate(
		// R.layout.residemenu_custom_right_scrollview, this, false);
		// layoutRightMenu = (LinearLayout)
		// scrollViewRightMenu.findViewById(R.id.layout_right_menu);
		// }
	...
	/**
	 * Returns right menu view so you can findViews and do whatever you want
	 * with
	 */
	...
	protected boolean fitSystemWindows(Rect insets) {
		...
		// This is added to fix soft navigationBar's overlapping to content
		// above LOLLIPOP
		...
		this.setPadding(viewActivity.getPaddingLeft() + insets.left, viewActivity.getPaddingTop() + insets.top,
				viewActivity.getPaddingRight() + insets.right, bottomPadding);
	...
	public boolean dispatchTouchEvent(MotionEvent ev) {
		if (AbSharedUtil.getString(activity, Constant.RESIDEMENU_TOUCHEVENT_TYPE).equals("false")) {
