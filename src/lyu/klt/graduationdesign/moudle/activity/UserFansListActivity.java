...
public class UserFansListActivity extends BaseActivity {
	...
	private static final String TAG = UserFansListActivity.class.getSimpleName();
	...
	public void initEvent() {
		...
		swipe_refresh_widget.setOnRefreshListener(new OnRefreshListener() {
			...
			public void onRefresh() {
				...
				UserAPI.queryUserFansInfo(context, userId, queryUserFansInfoStringHttpResponseListener);
			}
		});
	...
	private AbStringHttpResponseListener queryUserFansInfoStringHttpResponseListener = new AbStringHttpResponseListener() {
