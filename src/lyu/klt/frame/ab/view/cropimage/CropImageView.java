 ...
 */
package lyu.klt.frame.ab.view.cropimage;
...
public class CropImageView extends CropViewBase {
     ...
     * @see lyu.klt.frame.ab.view.cropimage.CropViewBase#onLayout(boolean, int, int, int, int)
     * @author: amsoft.cn
     ...
     * @see lyu.klt.frame.ab.view.cropimage.CropViewBase#zoomTo(float, float, float)
     * @author: amsoft.cn
     * @date：2013-6-17 上午9:04:49
     */
    @Override
     ...
     *
     * @version v1.0
     * @see lyu.klt.frame.ab.view.cropimage.CropViewBase#zoomIn()
     * @author: amsoft.cn
     * @date：2013-6-17 上午9:04:49
     */
    @Override
     ...
     *
     * @version v1.0
     * @see lyu.klt.frame.ab.view.cropimage.CropViewBase#zoomOut()
     * @author: amsoft.cn
     * @date：2013-6-17 上午9:04:49
     */
    @Override
     ...
     * @see lyu.klt.frame.ab.view.cropimage.CropViewBase#postTranslate(float, float)
     * @author: amsoft.cn
     * @date：2013-6-17 上午9:04:49
     */
    @Override
