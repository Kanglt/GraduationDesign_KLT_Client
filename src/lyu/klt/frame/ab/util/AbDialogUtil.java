...
import lyu.klt.frame.ab.fragment.AbAlertDialogFragment;
import lyu.klt.frame.ab.fragment.AbLoadDialogFragment;
import lyu.klt.frame.ab.fragment.AbProgressDialogFragment;
import lyu.klt.frame.ab.fragment.AbRefreshDialogFragment;
import lyu.klt.frame.ab.fragment.AbSampleDialogFragment;
import lyu.klt.frame.ab.fragment.AbAlertDialogFragment.AbDialogOnClickListener;
import lyu.klt.frame.ab.fragment.AbDialogFragment.AbDialogOnLoadListener;
...
public class AbDialogUtil {
	...
	public static void removeDialog(Context context){
		try {
			...
			//ft.addToBackStack(null);   //当前创建Dialog的类没有继承FragmentActivity的话不用加这句，addToBackStack是添加到堆栈中，可以模拟后退返回前一个Fragment
		    ft.commit();
		} catch (Exception e) {
			//可能有Activity已经被销毁的异常
			e.printStackTrace();
