...
* @Description: TODO(播放音乐用到的service) 
* @author 康良涛 
* @date 2016年12月26日 下午10:49:02 
*
 */
...
//                        .setSmallIcon(R.drawable.down_music).getNotification();
//            } else {
//                Notification.Builder builder = new Notification.Builder(this);
//                PendingIntent contentIntent = PendingIntent.getActivity(this, 0,
//                        new Intent(this, MusicListActivity.class), 0);
//                builder.setContentIntent(contentIntent);
//                builder.setSmallIcon(R.drawable.down_music);
