...
import lyu.klt.graduationdesign.module.adapter.RecommendedTrainingRecyclerAdapter;
...
/**
 * @ClassName: RecommendedTrainingActivity
 * @Description: TODO(显示推荐训练)
 * @author 康良涛
 * @date 2016年12月27日 上午9:13:30
 * 
 */
public class RecommendedTrainingActivity extends BaseActivity {

	private static final String TAG = RecommendedTrainingActivity.class.getSimpleName();
	...
	private RecyclerView rv_recommendedTraining;
	private RecommendedTrainingRecyclerAdapter mAdapter;
	...
	public void initView() {
		...
		rv_recommendedTraining = (RecyclerView) findViewById(R.id.rv_totalTraining);
	}
	...
	public void initViewData() {
		...
		// 设置Adapter
		rv_recommendedTraining.setAdapter(recycleAdapter);
		mLayoutManager = new MyLinearLayoutManger(context, LinearLayout.VERTICAL, false);
		rv_recommendedTraining.setLayoutManager(mLayoutManager);
		rv_recommendedTraining.setItemAnimator(new DefaultItemAnimator());
		// 每项周围的空隙是5，那么项与项之间的间隔就是5+5=10。
		SpacesItemDecoration decoration = new SpacesItemDecoration(1);
		rv_recommendedTraining.addItemDecoration(decoration);
	}
	...
	public void startGame() {
		// TODO Auto-generated method stub
		super.startGame();
		TrainingDataPAI.getRecommendedTraining(context, getRecommendedTrainingStringHttpResponseListener);
	}
	...
	private AbStringHttpResponseListener getRecommendedTrainingStringHttpResponseListener = new AbStringHttpResponseListener() {
		...
		public void onSuccess(int statusCode, String content) {
			...
			if (!StringUtil.isEmpty(content)) {
				try {
					...
					mAdapter = new RecommendedTrainingRecyclerAdapter(context, 1, trainingDataListPo);

					rv_recommendedTraining.setAdapter(mAdapter);
