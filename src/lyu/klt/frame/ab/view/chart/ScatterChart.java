 ...
 */
package lyu.klt.frame.ab.view.chart;
...
public class ScatterChart extends XYChart {
   ...
   * @see lyu.klt.frame.ab.view.chart.XYChart#setDatasetRenderer(lyu.klt.frame.ab.view.chart.XYMultipleSeriesDataset, lyu.klt.frame.ab.view.chart.XYMultipleSeriesRenderer)
   * @author: amsoft.cn
   ...
   * @see lyu.klt.frame.ab.view.chart.XYChart#clickableAreasForPoints(float[], double[], float, int, int)
   * @author: amsoft.cn
   * @date：2013-6-17 上午9:04:49
   */
  @Override
