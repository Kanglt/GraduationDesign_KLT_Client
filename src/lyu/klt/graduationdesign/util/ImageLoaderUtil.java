...
//				.showImageOnLoading(R.drawable.stampbookbox) // 设置图片在下载期间显示的图片
	//			.showImageForEmptyUri(R.drawable.stampbookbox)// 设置图片Uri为空或是错误的时候显示的图片
	//			.showImageOnFail(R.drawable.stampbookbox) // 设置图片加载/解码过程中错误时候显示的图片
