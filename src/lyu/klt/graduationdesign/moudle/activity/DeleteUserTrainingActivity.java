...
/** 
* @ClassName: SubUserTrainingActivity 
* @Description: TODO(删除训练) 
* @author 康良涛 
* @date 2016年12月27日 下午12:33:44 
*  
*/
public class DeleteUserTrainingActivity extends BaseActivity {

	private static final String TAG = DeleteUserTrainingActivity.class
			.getSimpleName();
	...
	private static RecyclerView rv_subUserTraining;
	private static DeleteUserTrainingRecyclerAdapter mAdapter;
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		setAbContentView(R.layout.activity_sub_user_training_layout);
		init(); 
	}
	...
	public void initView() {
		...
		rv_subUserTraining = (RecyclerView)findViewById(R.id.rv_subUserTraining);
	}
	...
	public void initViewData() {
		...
		super.initViewData();
		 ...
		 title_bar_left_img.setImageDrawable(context.getResources().getDrawable(
				 R.drawable.btn_return3));
		title_bar_text.setText("删除训练");
		...
		// 设置Adapter
		rv_subUserTraining.setAdapter(recycleAdapter);
		mLayoutManager = new MyLinearLayoutManger(context, LinearLayout.VERTICAL, false);
		rv_subUserTraining.setLayoutManager(mLayoutManager);
		rv_subUserTraining.setItemAnimator(new DefaultItemAnimator());
		// 每项周围的空隙是5，那么项与项之间的间隔就是5+5=10。
		SpacesItemDecoration decoration = new SpacesItemDecoration(1);
		rv_subUserTraining.addItemDecoration(decoration);
	}
		...
		public void onSuccess(int statusCode, String content) {
			...
			if (!StringUtil.isEmpty(content)) {
				try {
					...
					mAdapter = new DeleteUserTrainingRecyclerAdapter(context, 1, trainingDataListPo);

					rv_subUserTraining.setAdapter(mAdapter);
