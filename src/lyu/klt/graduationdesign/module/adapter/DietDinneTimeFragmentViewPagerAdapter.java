...
/**
 * 
* @ClassName: RecommendedFragmentViewPagerAdapter 
* @Description: TODO(为ViewPager添加布局（Fragment），绑定和处理fragments和viewpager之间的逻辑关系) 
* @author 康良涛 
* @date 2016年12月17日 下午12:24:00 
*
 */
public class DietDinneTimeFragmentViewPagerAdapter extends PagerAdapter implements ViewPager.OnPageChangeListener{
    private List<Fragment> fragments; // 每个Fragment对应一个Page
    private FragmentManager fragmentManager;
	private ViewPager viewPager; // viewPager对象
    private int currentPageIndex = 0; // 当前page索引（切换之前）
    private String[] titles={"减脂","增肌"};
    private OnExtraPageChangeListener onExtraPageChangeListener; // ViewPager切换页面时的额外功能添加接口
    private FragmentTransaction ft;

    public DietDinneTimeFragmentViewPagerAdapter(FragmentManager fragmentManager, ViewPager viewPager , List<Fragment> fragments) {
