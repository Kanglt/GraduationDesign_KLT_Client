package lyu.klt.frame.photoselector.util;
...
public class CommonUtils {
	...
	public static void launchActivityForResult(Activity context, Class<?> activity, int requestCode,int selectedNum) {
		Intent intent = new Intent(context, activity);
		intent.putExtra("intent", selectedNum);
		intent.addFlags(Intent.FLAG_ACTIVITY_NO_ANIMATION);
	...
	public static void launchActivityForResult(Activity activity, Intent intent, int requestCode) {
		...
		UrlConstant.PHOTOURI = activity.getContentResolver().insert(
		MediaStore.Images.Media.EXTERNAL_CONTENT_URI, values);

		intent.putExtra(MediaStore.EXTRA_OUTPUT, UrlConstant.PHOTOURI);
