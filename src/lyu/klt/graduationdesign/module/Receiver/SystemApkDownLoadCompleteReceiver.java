 ...
 * 
 */
public class SystemApkDownLoadCompleteReceiver extends BroadcastReceiver {
	...
	public void onReceive(Context context, Intent intent) {
		...
		if (intent.getAction().equals(DownloadManager.ACTION_DOWNLOAD_COMPLETE)) {
			...
			File file=new File(FileUtils.SDPATH+"/apk/"+DownLoadDialog.apkName);
		...
		if (intent.getBooleanExtra("isUnRegisterReceiver", false)) {
			// Toast.makeText(context, "注销了DownLoadCompleteReceiver",
