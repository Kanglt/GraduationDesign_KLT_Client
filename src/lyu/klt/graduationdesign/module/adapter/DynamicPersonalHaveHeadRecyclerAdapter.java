 ...
 *
 */
public class DynamicPersonalHaveHeadRecyclerAdapter extends RecyclerView.Adapter<ViewHolder>
	...
	public DynamicPersonalHaveHeadRecyclerAdapter(Context context, int type, List<DynamicPo> dynamicPoList) {
		mContext = context;
