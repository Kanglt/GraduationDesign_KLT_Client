 ...
 * @Description: TODO(推荐训练的RecyclerView的Adapter)
 * @author 康良涛
 * @date 2016年12月16日 下午10:01:51
 *
 */
public class RecommendedTrainingRecyclerAdapter extends RecyclerView.Adapter<ViewHolder>{
	private final static String TAG = "RecommendedTrainingRecyclerAdapter";
	private Context mContext;
	private LayoutInflater mInflater;
	private int mType;
	private List<TrainingDataListPo> trainingDataPoList;

	public RecommendedTrainingRecyclerAdapter(Context context, int type, List<TrainingDataListPo> trainingDataPoList) {
		mContext = context;
