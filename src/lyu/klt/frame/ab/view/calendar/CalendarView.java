	...
	public void initRow(){
		...
		for (int iRow = 0; iRow < 6; iRow++) {
			...
			for (int iDay = 0; iDay < 7; iDay++) {
				CalendarCell dayCell = new CalendarCell(context,(iRow*7)+iDay,cellWidth,rowHeight, cellTextSize,bgColor);
...
//			}
			...
			dayCell.setThisCellDate(iYear, iMonth, iDay, bToday,bSelected, bHoliday,currentMonth, hasRecord,hasNormal);
...
//			}
			...
			dayCell.setThisCellDate(iYear, iMonth, iDay, bToday,bSelected, bHoliday,currentMonth, false,false);
			calCalendar.add(Calendar.DAY_OF_MONTH, 1);
		}
	...
	public void setHeaderDefualColor(int defaultTextColor) {
		mCalendarHeader.setDefaultTextColor(defaultTextColor);
	}
	public void setHeaderSpecailColor(int specailColor) {
		mCalendarHeader.setSpecialTextColor(specailColor);
	}
	...
	public void setHeaderTextSize(int size) {
		if(width>500){
			mCalendarHeader.setTextSize(40);
		}else{
			mCalendarHeader.setTextSize(20);
		}
