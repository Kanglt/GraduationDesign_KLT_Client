 ...
 */
package lyu.klt.frame.ab.view.titlebar;
...
public class AbTitleBar extends LinearLayout {
	...
	protected int titleTextColor = Color.rgb(255, 255, 255);
	...
	public void ininTitleBar(Context context){
		...
		titleTextBtn.setTextColor(titleTextColor);
		...
		titleSmallTextBtn.setTextColor(titleTextColor);
